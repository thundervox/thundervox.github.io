...
遅かれ早かれ注釈付けながらソースコードをすべて読むので、遅くても一月中に終わらなくても問題ないってことで。細部にこだわり過ぎるのは今の作業段階ではないですから。ゆるく続けて気づいたらできていたくらいでいいんですよ。完璧なものが欲しいなら、日本円で五万円くらい用意して当時の開発環境と WindowsXP, Visual C++ 6.0 と Wintertree関連のライブラリを買ってきてご自身で保守したら良いだけです。
